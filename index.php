...
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDo6Aeq3MlAfLTBqy-TyXKnlxAz_lwgxR4&sensor=false"></script>
...
/* Marker Info Window */
h1.marker-heading{color: #585858;margin: 1px;padding: 0px;font: 18px "Trebuchet MS", Arial;border-bottom: 1px dotted #D8D8D8;}
div.marker-info-win {max-width: 300px;margin-right: -20px;}
div.marker-info-win p{padding: 0px;margin: 12px 0px 10px 0;}
